...
Most of these come down to network reality or how codinghorror serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

codinghorror rate-limits like any public site. ch already paces
...
Where a surface is gated, ch reads a cookie or token you supply
...
`ch`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ch actually did
